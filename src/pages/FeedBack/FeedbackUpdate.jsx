...
import { updateFeedbackDetail as updateDetailApi } from "../../apis/async.js";
    ...
    <FormLayout>
      ...
      <div className="btnWrapper">
        <div style={{ display: "flex", justifyContent: "flex-end" }}>
          ...
          />
          <GlobalButton onClick={clickUpdateHandler} text="수정" />
        </div>
      </div>
    </FormLayout>
  );
